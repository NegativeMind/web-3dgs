...
```html
<!-- オブジェクト閲覧モード（デフォルト） -->
<splat-viewer src="https://example.com/model.sog" scene-type="object" width="800px" height="480px"></splat-viewer>
...
<!-- 衝突メッシュをデバッグ表示 -->
<splat-viewer src="https://example.com/scene.sog" scene-type="immersive" collision-src="https://negativemind.com/3dgs/gmk.collision.glb" debug-collision width="800px" height="480px"></splat-viewer>
```
...
src/                    ← ウィジェットソース（<splat-viewer> Custom Element）
